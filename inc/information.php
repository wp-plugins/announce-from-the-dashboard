...
<div class="stuffbox" id="aboutbox">
	...
	<div class="inside">
		...
		<ul>
			...
			<li><a href="<?php echo $Afd->Plugin['links']['forum']; ?>" target="_blank"><?php _e( 'Support Forums' ); ?></a></li>
			<li><a href="<?php echo $Afd->Plugin['links']['review']; ?>" target="_blank"><?php _e( 'Reviews' , $Afd->Plugin['ltd'] ); ?></a></li>
...
<div class="stuffbox" id="usefulbox">
	...
	<div class="inside">
		...
		<p>&nbsp;</p>
		<p><a href="<?php echo $Afd->Plugin['links']['profile']; ?>" target="_blank"><?php _e( 'Plugins' ); ?></a></p>
	</div>
</div>
